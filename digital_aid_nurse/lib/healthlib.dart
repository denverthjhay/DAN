              ...
              Expanded(
                ...
                children: [
                  Container(
                      ...
                      child: ListTile(
                        title: Text(display_list[0].name!),
                        trailing: IconButton(
                          icon: const Icon(
                        ...
                        leading: SizedBox(
                          ...
                          width: 50,
                          child: Image(
                              image: AssetImage(display_list[0].image!),
                              fit: BoxFit.cover),
                        ),
                      )),
                  const SizedBox(
                  ...
                  Container(
                      ...
                      child: ListTile(
                        title: Text(display_list[1].name!),
                        trailing: IconButton(
                          icon: const Icon(
                            Icons.arrow_forward_ios,
                            color: Color.fromRGBO(6, 174, 213, 1),
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const BirdFluWidget()),
                            );
                          },
                        ),
                        leading: SizedBox(
                          ...
                          width: 50,
                          child: Image(
                              image: AssetImage(display_list[1].image!),
                              fit: BoxFit.cover),
                        ),
                      )),
                  const SizedBox(
                  ...
                  Container(
                      ...
                      child: ListTile(
                        title: Text(display_list[2].name!),
                        trailing: IconButton(
                          icon: const Icon(
                            Icons.arrow_forward_ios,
                            color: Color.fromRGBO(6, 174, 213, 1),
                        ...
                        leading: SizedBox(
                          ...
                          width: 50,
                          child: Image(
                              image: AssetImage(display_list[2].image!),
                              fit: BoxFit.cover),
                        ),
                      )),
                  const SizedBox(
                  ...
                  Container(
                      ...
                      child: ListTile(
                        title: Text(display_list[3].name!),
                        trailing: IconButton(
                          icon: const Icon(
                            Icons.arrow_forward_ios,
                            color: Color.fromRGBO(6, 174, 213, 1),
                        ...
                        leading: SizedBox(
                          ...
                          width: 50,
                          child: Image(
                              image: AssetImage(display_list[3].image!),
                              fit: BoxFit.cover),
                        ),
                      )),
                  const SizedBox(
                  ...
                  Container(
                      ...
                      child: ListTile(
                        title: Text(display_list[4].name!),
                        trailing: IconButton(
                          icon: const Icon(
                            Icons.arrow_forward_ios,
                            color: Color.fromRGBO(6, 174, 213, 1),
                        ...
                        leading: SizedBox(
                          ...
                          width: 50,
                          child: Image(
                              image: AssetImage(display_list[4].image!),
                              fit: BoxFit.cover),
                        ),
                      )),
                ],
